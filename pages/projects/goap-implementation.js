  ...
  return (
    <>
      ...
      <div className={styles.blogContent}>
        ...
        <p>
          This is the contents of the action class at the moment, it returns what goal is assigned to the object and
          takes away the value that the action is weighted at. The goal class is pretty much the same as the action
          class, so I won't bore you with all code for that one at this time. GOAP is the last class that I will be
          talking about in this log. Since it's quite a simple and short algorithm I will be bullet pointing the step it
          takes and putting the code at the end of this blog. The steps:
          ...
          And thats it pretty simple since we're just getting the maxium one and returning it. For the next blog I will
          be trying to get multiply action that need to be forfilled to obtain the correct goal.
        </p>
      </div>
    </>
  )
