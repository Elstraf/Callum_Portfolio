  ...
  return (
    <>
      ...
      <div className={styles.blogContent}>
        ...
        <p>
          This is the app that I developed for my masters android app module.The app allows users to sign into a
          database look at workouts that they can use, send images that all the other users can see and book times to
          use the gym.
        </p>
